...
#################################################	
echo "\makeatletter%" > $output_dir/check_import.tex
...
if [ "$1" == "--full" ];then 
	...
	makeglossaries $output_dir/$main #>> $renderReportFile
	echo -e "$green"
	...
	echo -e "$default"
	makeindex $output_dir/$main >> $renderReportFile
	makeindex $output_dir/$main.nlo -s nomencl.ist -o $output_dir/$main.nls >> $renderReportFile
	echo -e "$green"
